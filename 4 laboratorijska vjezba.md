...
Prvo smo završili 3.laboratorijske vježbe, a zatim krenili na novu lekciju naziva: **Password-hashing (iterative hashing, salt, memory-hard functions)**

Radimo skriptu: password_hashing.py

U komandnoj liniji instaliramo pakete koji su nam potrebni za izvrsavanje ovog koda: —>

from prettytable import PrettyTable

from passlib.hash import sha512_crypt, pbkdf2_sha256, argon2

Kopiramo cijeli kod sa direktorija sa GitHub-a:
...
def linux_hash(input, **kwargs):
		...
		rounds = kwargs.get("rounds", 5000)  #koliko puta cemo izvrtit funkciju
		if salt:
...
if __name__ == "__main__":
		...
		TESTS = [
				...
				{
						"name": "Linux CRYPT 5k",    #5 tisuca puta ce izvrtiti
...
time_it je wrapper funkcija koja mjeri vrijeme koje je potrebno da se izvrši kriptografska hash funkcija —> kod:
